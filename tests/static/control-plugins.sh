...
for localized_runtime_package in gettext locales arp-scan; do
    grep -Fxq "$localized_runtime_package" "$PROJECT_DIR/packages/wasalight-runtime.txt" || \
        fail "l'installer non installa $localized_runtime_package"
done
